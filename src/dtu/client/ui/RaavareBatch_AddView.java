...
public class RaavareBatch_AddView extends Composite {
	...
	public RaavareBatch_AddView(final KartotekServiceClientImpl clientImpl) {
		...
		// Der er forkerte rules på NOmNeto
		...
		save.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				RaavareBatchDTO newRaavareBatch= new RaavareBatchDTO(Integer.valueOf(raavareidTxt.getText()), Integer.valueOf(raavareBatchIdTxt.getText()), Double.valueOf(maengdeTxt.getText()));
